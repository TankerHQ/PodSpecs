...
It's available for browsers, desktop, iOS and Android.
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_LDFLAGS' => "'-exported_symbols_list ${PODS_TARGET_SRCROOT}/export_symbols.list -nostdlib++ -ltankertrustchain -ltankercore -ltls -lcrypto -lboost_context -lc++ -ltankerfunctionalhelpers -lsioclient -ltankerstreams -lboost_thread -lboost_program_options -ltankerformat -lboost_atomic -lboost_random -lboost_date_time -lsqlcipher -lfmt -lfetchpp -ltankertesthelpers -lc++abi -lboost_system -ltanker_admin-c -ltconcurrent -ltankernetwork -ltankerserialization -lsodium -ltankercacerts -ltankeradmin -lssl -lsqlpp11-connector-sqlite3 -lctanker -ltankeridentity -ltankercrypto -ltankerlog -lboost_filesystem -ltanker_async -lboost_chrono -ltankererrors'"
    }
